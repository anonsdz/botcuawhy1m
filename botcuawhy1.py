...
TOKEN, ADMIN_ID, GROUP_ID, VIP_USERS_FILE, METHODS_FILE, user_processes = '7582640219:AAHzedxZ8WvFQ9CUU4mXiXw3KFVSZLU8Oi8', 5929440805, -1002328993995, 'vip_users.json', 'methods1.json', {}
...
async def attack_method(update, context, methods_data, vip_users): 
    ...
    if chat_id != GROUP_ID: return await update.message.reply_text("Bạn không có quyền sử dụng methods [ADMIN] Liên hệ [@nonstopzq 👑]")
...
async def help_message(update, context):
    await update.message.reply_text("[👑Owner👑@nonstopzq] Buy BOT theo Tuần/Tháng Build BOT server riêng biệt contact @nonstopzq:**\n\n"
